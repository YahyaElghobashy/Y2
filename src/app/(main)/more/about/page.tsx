  ...
  return (
    <PageTransition>
      ...
      <div className="flex flex-col gap-6 px-5 py-6">
        <section>
          <h2 className="font-display text-[20px] font-semibold text-[var(--color-text-primary)]">
            Why Hayah?
          </h2>
          <p className="mt-2 font-body text-[14px] leading-relaxed text-[var(--color-text-secondary)]">
        ...
        <p className="mt-4 text-center font-body text-[13px] text-[var(--color-text-muted)]">
